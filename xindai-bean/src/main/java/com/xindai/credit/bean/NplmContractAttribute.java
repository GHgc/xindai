package com.xindai.credit.bean;
...
@Entity
@Table(name = "nplm_contract_attribute", schema = "credit", catalog = "")
public class NplmContractAttribute implements Serializable{
    ...
    private String typeOfContractChange;
    ...
    @Basic
    @Column(name = "TYPE_OF_CONTRACT_CHANGE")
    public String getTypeOfContractChange() {
        return typeOfContractChange;
    }

    public void setTypeOfContractChange(String typeOfContractChange) {
        this.typeOfContractChange = typeOfContractChange;
    }

    @Basic
    @Column(name = "CONTRACT_CHANGE_AMOUNT")
    public String getContractChangeAmount() {
        return contractChangeAmount;
    }

    public void setContractChangeAmount(String contractChangeAmount) {
        this.contractChangeAmount = contractChangeAmount;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (typeOfContractChange != null ? !typeOfContractChange.equals(that.typeOfContractChange) : that.typeOfContractChange != null)
            return false;
        if (contractChangeAmount != null ? !contractChangeAmount.equals(that.contractChangeAmount) : that.contractChangeAmount != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (typeOfContractChange != null ? typeOfContractChange.hashCode() : 0);
        result = 31 * result + (contractChangeAmount != null ? contractChangeAmount.hashCode() : 0);
